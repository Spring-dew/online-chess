!function (e, t) {
  ...
  class i {
    ...
    _initState() {
      this._results = {
        command: void 0, headers: [], binaryBody: void 0
    ...
    constructor(e, t, s) {
      this._client = e, this._webSocket = t, this._connected = !1, this._serverFrameHandlers = {
        CONNECTED: e => {
          ...
          const t = e.headers.subscription, s = this._subscriptions[t] || this.onUnhandledMessage, n = e, i = this,
    ...
    discardWebsocket() {
      ...
      "function" != typeof this._webSocket.terminate && (e = this._webSocket, t = e => this.debug(e), e.terminate = function () {
        ...
        this.onclose = e => {
          ...
          code: 4001, reason: `Quick discarding socket (#${i}) without waiting for the shutdown sequence.`, wasClean: !1
        })
  ...
  class l extends h {
    ...
    send(e, t = {}, s = "") {
      ...
      n && delete t["content-length"], this.publish({destination: e, headers: t, body: s, skipContentLengthHeader: n})
    }
